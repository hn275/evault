...
def upgrade() -> None:
    ...
    op.add_column('repositories', sa.Column('name', sa.String(length=255), nullable=False))
    op.add_column('repositories', sa.Column('bucket_addr', sa.String(length=255), nullable=True))
    op.create_foreign_key('repositories_owner_id_fkey', 'repositories', 'users', ['owner_id'], ['id'], ondelete='CASCADE')
